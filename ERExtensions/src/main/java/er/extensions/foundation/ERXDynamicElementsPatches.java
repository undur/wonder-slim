...
/**
 * Element class substitutions (WOString -> ERXWOString, etc.) are installed
 * using parsley-tag-aliases.properties, making the element substitution
 * statically declared and tooling-readable.
 */

public class ERXDynamicElementsPatches {

	private ERXDynamicElementsPatches() {}
